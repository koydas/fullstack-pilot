...
- `services/apps-service` (Node.js + MongoDB): migrate-mongo
...
- otherwise the service fails fast if pending migrations are detected
...
- Rollback strategy:
  ...
  - migrate-mongo: `npm run migrate:down`
